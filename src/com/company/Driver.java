...
public class Driver {
	...
	public static void main(String[] args) {
		...
		while (notEnded) {
			//Sample menu for the console based calculator
			System.out.println("Write the function, followed by its values:");
			System.out.println("- arccos(x)");
			System.out.println("- ab(a, b, x)");
			System.out.println("- log(base, x)");
			System.out.println("- MAD(value1, value2, ...)");
			System.out.println("- std(value1, value2, ...)");
